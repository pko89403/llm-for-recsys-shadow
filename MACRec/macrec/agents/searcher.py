...
class Searcher(ToolAgent):
    ...
    def invoke(self, argument: Any, json_mode: bool) -> str:
        if not isinstance(argument, str):
            return f"Incorrect argument type: {type(argument)}. Must be a string."
...
if __name__ == "__main__":
    ...
    searcher = Searcher(config_path="config/agents/searcher.json", prompts=read_prompts("config/prompts/agent_prompt/searcher.json"))
    while True:
